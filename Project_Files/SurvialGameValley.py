...
#Caption and Icon
pygame.display.set_caption("./Assets/Survival Death Valley")
icon=pygame.image.load("./Assets/car_icon.png")
...
backgroundpic=pygame.image.load("./Assets/grass.jpg")
yellow_strip=pygame.image.load("./Assets/yellow_strip.jpg")
white_strip=pygame.image.load("./Assets/white_strip.jpg")
strip=pygame.image.load("./Assets/strip.jpg")
intro_background=pygame.image.load("./Assets/ibg2.jpg")
instruction_background=pygame.image.load("./Assets/ibg1.jpg")
pause_background=pygame.image.load("./Assets/ibg3.jpg")
crash_background=pygame.image.load("./Assets/bg4.jpg")
credit_background=pygame.image.load("./Assets/credits.jpg")

#loading car images
car_pic1=pygame.image.load("./Assets/car1.png")
car_pic2=pygame.image.load("./Assets/car2.png")
car_pic3=pygame.image.load("./Assets/car3.png")

car_pic4=pygame.image.load("./Assets/car4r.png")
car_pic5=pygame.image.load("./Assets/car5r.png")
car_pic6=pygame.image.load("./Assets/car6r.png")


#loading sound/music
intro_sound=pygame.mixer.Sound('./Assets/kgf_intro.mpeg')
game_sound=pygame.mixer.Sound('./Assets/game.mpeg')
...
def introduction():                   #For Introduction Page
    ...
    while intro:                                
        ...
        largetext=pygame.font.Font('./Assets/madjoe.ttf',150)
...
def button(msg,x,y,w,h,ic,ac,action=None,score=None):       #to draw the button on the screen
    ...
    smalltext=pygame.font.Font("./Assets/batman.ttf",20)                 
...
def credits():                                   #For the Credit Page which mentions the members of the project
    ...
    while credit:
        ...
        largetext=pygame.font.Font('./Assets/valorant.ttf',80)
        smalltext=pygame.font.Font('./Assets/batman.ttf',30)
        mediumtext=pygame.font.Font('./Assets/batman.ttf',60)
...
def instructions():                              #For the Instruction Page
    ...
    while instruction:
        ...
        largetext=pygame.font.Font('./Assets/valorant.ttf',80)
        smalltext=pygame.font.Font('./Assets/batman.ttf',17)
        mediumtext=pygame.font.Font('./Assets/valorant.ttf',60)
        ...
        xtextSurf,xtextRect=text_objects(" and border/fence of the road.",smalltext,black)
        xtextRect.center=((450),(180))
        xtextSurf1,xtextRect1=text_objects("Try to survive the death valley by staying on the road",smalltext,black)
        xtextRect1.center=((450),(210))        
        ytextSurf,ytextRect=text_objects("Your score is based on the number of cars you passed.",smalltext,black)
        ytextRect.center=((450),(260))
        ...
        screen.blit(xtextSurf1,xtextRect1)
...
def pause_game(score):
    ...
    while pause:
            ...
            largetext=pygame.font.Font('./Assets/valorant.ttf',115)
            ...
            text=pygame.font.Font("./Assets/batman.ttf",40)
...
def countdown_background():                         # displaying countdown to start the game
    font=pygame.font.Font('./Assets/batman.ttf',20)
...
def score_system(passed,score):                                  # to display the score during the game
    font=pygame.font.Font("./Assets/batman.ttf",20)                       # and cars dodged/passed during the game
...
def incomming_car(img, img1, img2, car1_x, car2_x, car3_x, car1_y, car2_y, car3_y):        
...
def game_loop():
    ...
    while not bumped:
        ...
        incomming_car(img, img1, img2, car1_x, car2_x, car3_x, car1_y, car2_y, car3_y)#function for movements of obstacles
